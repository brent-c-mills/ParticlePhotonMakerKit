...
int led = D0; // This time, we'll replace D7 with D0.  This single change will update every instance of "led" in our code.

void setup() {

  // We are going to tell our Photon that "led" (defined above as pin D0) is going to be configured for output using the "pinMode" function.
